...
public class PortfolioDescription extends AppCompatActivity {
...
//        clickImg.startAnimation(animation3);
        ...
        btn2.setText(DESCRIPTION+" Portfolios");


        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://a2zportfolio.com/contents/en-us/p2_Create-Portfolio-Online.html")));
            }
        });
...
//                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(PortfolioLink)));
                Intent intent=new Intent(getApplicationContext(), WebViewActivity.class);
                intent.putExtra("Link",PortfolioLink);
