...
public class MaleAudition extends AppCompatActivity {

    GifImageView men1,men2,men3,men4;
   ...
   LinearLayout register_now,create_profile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_male_audition);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        men1=findViewById(R.id.men1);
        men2=findViewById(R.id.men2);
        men3=findViewById(R.id.men3);
        men4=findViewById(R.id.men4);
...
//        Picasso.with(this).load("https://images.backstageaudition.com/click_img.png").fit().into(clickImg);
       // Glide.with(this).load("https://images.backstageaudition.com/chat_gif.gif").into(fab);
        ...
        Glide.with(this).load("https://images.backstageaudition.com/men1.gif").into(men1);
        Glide.with(this).load("https://images.backstageaudition.com/men2.gif").into(men2);
        Glide.with(this).load("https://images.backstageaudition.com/men3.gif").into(men3);
        Glide.with(this).load("https://images.backstageaudition.com/men4.gif").into(men4);
...
//                intent.putExtra("Link","https://forms.gle/g82Q6dMZ3Az9vp6t6");
//                startActivity(intent);
//            }
//        });
//        men2.setOnClickListener(new View.OnClickListener() {
...
//            public void onClick(View v) {
//                Intent intent=new Intent(getApplicationContext(), WebViewActivity.class);
//                intent.putExtra("Link","https://forms.gle/yNkTEJEqh9exYPxT7");
//                startActivity(intent);
//            }
//        });
...
//            public void onClick(View v) {
//                Intent intent=new Intent(getApplicationContext(), WebViewActivity.class);
//                intent.putExtra("Link","https://forms.gle/tLb9sUorSoE1j4ki6");
//                startActivity(intent);
//            }
//        });
...
//            public void onClick(View v) {
//                Intent intent=new Intent(getApplicationContext(), WebViewActivity.class);
//                intent.putExtra("Link","https://forms.gle/Wi1XDx3EvjTb8AXJ6");
//                startActivity(intent);
//            }
//        });
