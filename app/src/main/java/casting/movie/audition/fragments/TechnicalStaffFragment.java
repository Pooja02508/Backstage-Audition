...
public class TechnicalStaffFragment extends Fragment implements ContactAdapter.ItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_technical_staff, container, false);
        ...
        Glide.with(getActivity()).load("https://images.backstageaudition.com/technical_staff_gif.gif").into(cameraman_gif);
        Picasso.with(getActivity()).load("https://images.backstageaudition.com/technical_staff_image.png").fit().into(portfolio_icon);
