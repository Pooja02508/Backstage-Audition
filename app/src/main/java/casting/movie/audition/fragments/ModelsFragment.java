...
public class ModelsFragment extends Fragment implements ContactAdapter.ItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Glide.with(getActivity()).load("https://images.backstageaudition.com/models_gif.gif").into(cameraman_gif);
        Picasso.with(getActivity()).load("https://images.backstageaudition.com/models_image.png").fit().into(portfolio_icon);
