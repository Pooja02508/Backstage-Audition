...
public class DancersFragment extends Fragment implements ContactAdapter.ItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_dancers, container, false);
        ...
        Glide.with(getActivity()).load("https://images.backstageaudition.com/dancers_gif.gif").into(cameraman_gif);
        Picasso.with(getActivity()).load("https://images.backstageaudition.com/dancers_image.png").fit().into(portfolio_icon);
