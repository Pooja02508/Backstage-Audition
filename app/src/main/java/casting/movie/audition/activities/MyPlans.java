...
public class MyPlans extends AppCompatActivity {
    ...
    TextView subscription,proplans;
    LinearLayout subLayout,planLayout,ll;
    final int UPI_PAYMENT = 0;
    Button pay;
    String charges;
    RadioButton plan1,plan2,plan3;
    CheckBox proplan1,proplan2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        proplans=findViewById(R.id.proplans);
        ...
        proplan1=findViewById(R.id.proplan1);
        proplan2=findViewById(R.id.proplan2);
        ...
        plan1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                proplan1.setChecked(false);
                proplan2.setChecked(false);

                charges="159.00";
                pay.setText("Pay "+charges);
            }
        });
        ...
        proplan1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                plan2.setChecked(false);
                plan3.setChecked(false);
        ...
        proplan2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                plan2.setChecked(false);
                plan3.setChecked(false);
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                payUsingUpi("Casting Movie Audition", "247helpdesk@ibl", "Subscribe for Plans", charges);
